...
public class GameOverMenuEffects : MonoBehaviour {
	
	public AudioClip selectSound;
	private GameOverMenuManager menuManagerScript;
	...
	void Start () {
		menuManagerScript = GameObject.Find("Main Camera").GetComponent<GameOverMenuManager>();
	}
